  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-200 pb-6 mb-2">
         <div>
             <h1 className="text-2xl font-bold text-gray-900">全局 SEO 配置</h1>
             <p className="text-sm text-gray-500 mt-1">管理全站默认的 Title、Description 和 Meta 关键词</p>
         </div>
         <button 
           onClick={handleSave} 
           disabled={saving}
        ...
        <div className="p-6 border-b border-gray-50 bg-gray-50/30">
          <div className="flex items-center gap-3">
             ...
             <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">这些设置将应用于全站所有未设置独立 SEO 的页面，对搜索引擎机器人友好优化。</p>
             </div>
          </div>
        </div>
